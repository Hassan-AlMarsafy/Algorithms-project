...
pair<int, vector<tuple<char, pair<int, int>, pair<int, int>>>> bfs_min_moves(
...
int main() {
    pair<int, vector<tuple<char, pair<int, int>, pair<int, int>>>> result = bfs_min_moves(initial_white_positions, initial_black_positions);
